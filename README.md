...
Three inference engines for Llama 3: pure C for native applications, pure JavaScript for Node.js, and pure JavaScript for Web environments. Supports both Llama and Gemma architectures.
